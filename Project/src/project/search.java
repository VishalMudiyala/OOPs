...
public class search {
	search(int i){
		...
		//f.setSize(455,320);
		f1.setSize(300,300);
		f.setLayout(null);f1.setLayout(null);
		f.setVisible(true);
		f.setBackground(Color.BLACK);f1.setBackground(Color.BLACK);
		f.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);f1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
