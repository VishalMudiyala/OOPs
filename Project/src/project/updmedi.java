...
public class updmedi {
	updmedi(){
		JFrame f = new JFrame("Update Medicine");
		...
		JTextField t1,t2,t3,t4,t5,d1,d2,m1,m2,y1,y2;
		JPanel p = new JPanel();
		p.setLayout(null);
		...
		a.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int te=0;
					...
					int r = 0;
					try {
						if(((t1.getText()).equals(""))||((t2.getText()).equals(""))||((t3.getText()).equals(""))||((t4.getText()).equals(""))||((t5.getText()).equals(""))||((l.getSelectedItem()).equals(""))||((d1.getText()).equals(""))||((d2.getText()).equals(""))||((y1.getText()).equals(""))||((y2.getText()).equals(""))){
					    JOptionPane.showMessageDialog(null,"* Detail are Missing !","Warning!!!",JOptionPane.WARNING_MESSAGE);
							...
							String sql="update medicine set mfgdate='"+dt1+"',expdate='"+dt2+"',mrp='"+s4+"',quantity='"+s5+"',mtype='"+l.getSelectedItem()+"'where cname='"+s1+"' and mid='"+Integer.parseInt(s2)+"' and mname='"+s3+"'";
